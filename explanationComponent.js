...
export function Explanation() {
  return (
    <View style={styles.explanationWrapper}>
      ...
      <Text style={styles.explanationText}>These chords come in many different types, the most simple of which are major and minor. What intervals make up the chord determine its type
      (such as minor thirds, diminished fifths, etc).</Text>
      ...
      lowercase, as well as which symbols, if any, need to be added. For example, if a chord is major, its roman numeral will be capitalized; if it's minor, its roman
      numeral will be lowercase.
      </Text>
