//musicQuotes is a list of lists, where each sublist contains quote body and then the author
...
export const musicQuotes = [
  ...
  [
    "I am afraid that in ‘thinking up’ music I usually have some kind of a brass band with wings on it in the back of my mind.",
    'Charles Ives'
  ],
  [
  ...
  [
    "I always tell everybody: As soon as the Cubans come, a lot of people are going to have to go back to school all over again.",
    "Tito Puente"
  ],
  [
  ...
  [
    "Soul ties. The thing that can make you hear an old-school slow jam and think of somebody you haven’t seen in years. Soul ties. The thing that makes old people who’ve been together for years finish each other’s sentences.",
    "Kirk Franklin"
  ],
  [
    "The great thing about playing clubs in Harlem is people have an appreciation not just for the music but for the history of the music.",
    "Christian Scott"
  ],
  [
  ...
  [
    "I am in synchronization with life, with people, with nature. I try to be a part of all the things people do in the world so my music can give them strength, love, and faith. My gift to others is my love of music, and I will give it until I die.",
    "Giovanni Hidalgo"
  ],
  [
  ...
  [
    ...
    "Vladimir Horowitz, on Arturo Michelangeli"
  ],
  [
  ...
  [
    "I don't think you can be a great composer unless you have a feeling for harmony.",
    "John Adams"
  ],
  [
  ...
  [
    "Music can be all things to all men. It is like a great dynamic sun in the center of a solar system which sends out its rays and inspiration in every direction.",
    "Leopold Stokowski"
  ],
  [
  ...
  [
    ...
    "Erik Satie, instruction to the performer"
  ],
  [
    "Open your head.",
    "Erik Satie, instruction to the performer"
  ...
  [
    "But isn’t it part of the great attraction of music that what it says cannot be expressed in any other way?",
    "Witold Lutoslawski"
  ],
  [
    "Hear that? I'm gonna get THAT CHORD on the radio!",
    "Prince"
  ],
  [
  ...
  [
    "When you play or at least try to understand different sides of music, you become a better musician, like when you can speak different languages. You understand life better, you know?",
    "Paquito D’Rivera"
  ],
  [
    "We put a crab in the baritone saxophone and it was in the middle of a military parade. Yeah, then Raoul Castro was there. It was very dangerous. Castro was there and [sings a few bars]. Then the crab [jumped out], WHAM, just like that, AHHHHH! And then the guy threw the saxophone in the middle of it. I don’t know how I am alive here right now. It was just an innocent joke, you know. A good sense of humor is important.",
    "Paquito D’Rivera"
  ],
  [
